                    ...
                    <div class="movie-img sticky-sb">
                        ...
                        <div class="movie-btn">
                            <div class="btn-transform transform-vertical red">
                                <div><a href="#" class="item item-1 redbtn"> <i class="fa-solid fa-play"></i> Watch
                                        Trailer</a>
                                </div>
                                <div><a href="{{ $movie->trialer }}"
                ...
                <div class="col-md-8 col-sm-12 col-xs-12">
                    <div class="movie-single-ct main-content">
                        <h1 class="bd-hd">{{ $movie->title }}
                            <span>{{ date('Y', strtotime($movie->release_date)) }}</span></h1>
                        <div class="social-btn">
                            <a href="#" class="parent-btn"><i class="fa-regular fa-heart"></i> Add to Favorite</a>
                        </div>
                                            ...
                                            <div class="col-md-4 col-xs-12 col-sm-12">
                                                <div class="sb-it">
                                                    ...
                                                    @foreach($movie->directors as $director)
                                                        <p><a href="/celebrities/{{ $director->id }}">{{ $director->name }}</a></p>
                                                    @endforeach
                                                </div>
                                                <div class="sb-it">
                                                    <h6>Stars: </h6>
                                                    @foreach($movie->actors as $actor)
                                                        <p><a href="/celebrities/{{ $actor->id }}">{{ $actor->name }}</a></p>
                                                    @endforeach
                                                </div>
                                                <div class="sb-it">
                                                    <h6>Genres:</h6>
